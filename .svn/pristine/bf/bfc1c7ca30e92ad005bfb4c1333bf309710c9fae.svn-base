...
import AttributeBase from '../utilities/Attribute/AttributeBase';
...
class RightItems extends Component {
    ...
    render() {
        ...
        const { onFormSubmission, onFormClose, initId, vendor } = this.props;
                                                        ...
                                                        <Col>
                                                            <React.Fragment>
                                                                <Media className="mt-2 mb-2 p-3" style={{ backgroundColor: "#fff" }}>
                                                                    <Media body >
                                                                        <AttributeBase onFinish={onFormSubmission} onFormClose={onFormClose} initId={initId} vendor={vendor}></AttributeBase>
                                                                    </Media>
                                                                </Media>
