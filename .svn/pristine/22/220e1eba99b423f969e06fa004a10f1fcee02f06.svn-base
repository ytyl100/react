...
import { Row, Col, Card, CardBody, Input, UncontrolledDropdown, DropdownMenu, DropdownItem, DropdownToggle, Button } from 'reactstrap';
...
const TableWithSearch = () => {
    ...
    return (
        <Card>
            <CardBody>
                <h4 className="header-title mt-0 mb-1">Search and Export1</h4>
