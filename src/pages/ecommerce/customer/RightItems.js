...
import CustomerBase from '../utilities/Customer/CustomerBase';
import CustomerDeliveryAddress from '../utilities/Customer/CustomerDeliveryAddress';
                            ...
                            <Nav tabs>
                                <NavItem>
                                    <NavLink
                                        ...
                                        onClick={() => { this.toggleTab('detail'); }}>客户基本信息</NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink
                                        href="#"
                                        className={classNames({ active: this.state.activeTab === 'advance' })}
                                        onClick={() => { this.toggleTab('advance'); }}>客户地址信息</NavLink>
                                </NavItem>
                            </Nav>
                                                        ...
                                                        <Col>
                                                            <React.Fragment>
                                                                <Media className="mt-2 mb-2 p-3" style={{ backgroundColor: "#fff" }}>
                                                                    <Media body >
                                                                        <CustomerBase onFinish={onFormSubmission}></CustomerBase>
                                                                    </Media>
                                                                </Media>
                                                    ...
                                                    <Row>
                                                        <Col>
                                                            <React.Fragment>
                                                                <Media className="mt-2 mb-2 p-3" style={{ backgroundColor: "#fff" }}>
                                                                    <Media body >
                                                                        <CustomerDeliveryAddress onFinish={onFormSubmission}></CustomerDeliveryAddress>
                                                                    </Media>
                                                                </Media>
                                                            </React.Fragment>
                                                        </Col>
