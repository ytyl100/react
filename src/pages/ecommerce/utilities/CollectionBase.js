    ...
    return (
        ...
        >
            <Media className="mt-2 mb-2 p-3" style={{ backgroundColor: "#fff", fontSize: "15px" }}>
                <Media body >
                    <h6 className="mt-0 mb-2 header-title">产品系列信息的录入</h6>
                    <hr></hr>
                    <Form.Item label="启动产品系列" valuePropName="checked" className="mt-0 mb-0 p-2">
                        <Switch />
                    </Form.Item>
                    <Form.Item
                        name="storename"
                        label="产品系列标题"
                        tooltip="当前的产品系列标题是什么?"
                        rules={[
                            {
                                required: true,
                                message: '请输入产品系列标题',
