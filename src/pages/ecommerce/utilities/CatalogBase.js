...
const CatalogBase = ({ onFinish, handleFileListChange, fileList,
    catalogInitVal, catalog_active, catalog_enable, catalog_name, catalog_intro, catalog_description }) => {
    ...
    console.log('pass catalogInitVal:', catalog_name);
    return (
        <Form
            {...formItemLayout}
            form={form}
